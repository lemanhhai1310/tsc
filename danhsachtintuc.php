...
<div class="uk-container uk-margin-bottom">
    ...
    <div class="uk-grid-small" uk-grid>
        <div class="uk-width-expand@m">
            <h3 class="title_c uk-text-uppercase uk-margin">tin tức</h3>
            <div>
                <div class="danhsach1">
                    <div class="uk-grid-collapse" uk-grid>
                        <div class="uk-width-auto@s">
                            <div class="uk-cover-container">
                                ...
                                <canvas width="281" height="177"></canvas>
                            </div>
                        </div>
                        <div class="uk-width-expand@s">
                            <div class="uk-padding-small box4">
                                <h3 class="title3 uk-margin-remove-top uk-margin-bottom" style="min-height: inherit"><a href="#">Ông Kim 'thị sát kinh tế' trước kỳ họp quốc hội Triều Tiên</a></h3>
                                <ul class="uk-grid-small" uk-grid>
                                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 11/7/2016</li>
                                    <li><i class="fa fa-eye" aria-hidden="true"></i> 2.658 người xem</li>
                                </ul>
                                <p>Tại phiên họp Chính phủ thường kỳ tháng 7, thay mặt Bộ Giáo dục và Đào tạo (GD&ĐT), Bộ trưởng Phùng Xuân Nhạ đã báo cáo về tình hình tổ chức Kỳ thi THPT quốc gia năm 2018 và việc xử lý tiêu cực trong khâu chấm thi</p>
                                <div class="uk-text-right">
                                    <a href="#" class="uk-button uk-button-default btn1">chi tiết</a>
                                </div>
                            </div>
                        </div>
                    </div>
