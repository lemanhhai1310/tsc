...
<div class="uk-container uk-margin-bottom">
    ...
    <div class="uk-grid-small" uk-grid>
        <div class="uk-width-expand@m">
            <h3 class="title_c uk-text-uppercase uk-margin">văn bản</h3>
            <div class="uk-overflow-auto">
                <table class="uk-table uk-table-striped table1">
                    ...
                    <tr>
                        <td>1</td>
                        <td><a href="">Bộ trưởng Phùng Xuân Nhạ báo cáo Chính phủ về kỳ thi THPT quốc gia</a></td>
                        <td>22/07/2017</td>
                        <td>127KB</td>
                        <td>.PDF</td>
                        <td><a href="#">Tải về <span uk-icon="download"></span></a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
